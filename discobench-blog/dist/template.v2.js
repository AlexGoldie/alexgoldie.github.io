...
`);
  ...
  d-byline .authors-affiliations {
    /* Span 3 columns so names have plenty of room */
    grid-column-end: span 3;
    /* Stack vertically: Label on top, Names below */
  ...
  /* FIXED: Applies to ALL h3s (Authors & Published) so they look consistent */
  d-byline h3 {
    font-size: 0.6rem;
    font-weight: 400;
    color: rgba(0, 0, 0, 0.5);
